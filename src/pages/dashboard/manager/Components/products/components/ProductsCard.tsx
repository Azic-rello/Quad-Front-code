...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-red-100/50 shadow-[0_4px_20px_rgb(0,0,0,0.01)] overflow-hidden hover:shadow-[0_12px_30px_rgb(227,18,33,0.06)] hover:-translate-y-1 transition-all group flex flex-col h-full max-w-sm animate-in fade-in duration-300">
      ...
      <div className="p-4 flex flex-col flex-1 justify-between space-y-3">
        <div>
          ...
          {product.description && (
            <p className="text-xs text-stone-500 font-normal line-clamp-2 min-h-8 leading-relaxed">
              {product.description}
            </p>
          )}
        </div>
